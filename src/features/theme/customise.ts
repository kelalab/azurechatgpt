...
export const DISCLAIMER_TEXT =
  "Kela-työssä saa käyttää vain Kelan hyväksymiä pilvipalveluita. Julkisissa pilvipalveluissa, pilotti- ja koestuskäytössä olevissa järjestelmissä ja kumppaneiden työtiloissa ei saa käsitellä salassa pidettävää tietoa (esim. asiakkaiden tiedot).";
