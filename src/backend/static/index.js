      ...
      jsx_dev_runtime.jsxDEV("div", {
        ...
        children: messages.map((message, idx) => {
          if (message.user === AI_NAME) {
            return jsx_dev_runtime.jsxDEV("div", {
              className: "border-2 self-end w-4/5",
              children: [
                jsx_dev_runtime.jsxDEV("div", {
...
var ChatInput = (props) => {
  ...
  const sendMessage = async (message) => {
    ...
    if (messages.length === 0) {
      const my_msg = { message, user: "Me" };
      addMessage(my_msg);
      const response = await fetch(`/message?message=${message}`, {
        headers: {
...
var ChatWindow = (props) => {
  ...
  return jsx_dev_runtime3.jsxDEV("div", {
    children: [
      jsx_dev_runtime3.jsxDEV(ChatHistory_default, {
        messages
      }, undefined, false, undefined, this),
      jsx_dev_runtime3.jsxDEV(ChatInput_default, {
        addMessage,
        messages
      }, undefined, false, undefined, this)
    ]
...
var Page = ({ children }) => {
  return jsx_dev_runtime4.jsxDEV("html", {
    children: [
      jsx_dev_runtime4.jsxDEV("head", {
        children: [
          jsx_dev_runtime4.jsxDEV("meta", {
            charSet: "utf-8"
          }, undefined, false, undefined, this),
          jsx_dev_runtime4.jsxDEV("title", {}, undefined, false, undefined, this),
          jsx_dev_runtime4.jsxDEV("meta", {
            name: "description",
...
var App = () => {
  const [messages, setMessages] = import_react3.useState([]);
  const addMessage = (message) => {
    console.log("messages before", messages);
    setMessages([...messages, message]);
    console.log("messages after", messages);
  };
  return jsx_dev_runtime5.jsxDEV(Page_default, {
    children: jsx_dev_runtime5.jsxDEV(ChatWindow_default, {
      messages,
      addMessage
    }, undefined, false, undefined, this)
  }, undefined, false, undefined, this);
...
client.hydrateRoot(document, jsx_dev_runtime6.jsxDEV(App_default, {}, undefined, false, undefined, this));
